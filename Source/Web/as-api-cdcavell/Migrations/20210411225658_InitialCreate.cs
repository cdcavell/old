        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserRoleClaims_AspNetRoleClaims_RoleClaimId",
                        column: x => x.RoleClaimId,
                        principalTable: "AspNetRoleClaims",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoleClaims_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoleClaims_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "AspNetUserRoleClaimHistories",
                columns: table => new
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    UserRoleClaimId = table.Column<string>(type: "TEXT", nullable: false),
                    ActionOn = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ActionById = table.Column<string>(type: "TEXT", nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserRoleClaimHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoleClaimHistories_AspNetUserRoleClaims_UserRoleClaimId",
                        column: x => x.UserRoleClaimId,
                        principalTable: "AspNetUserRoleClaims",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoleClaimHistories_AspNetUsers_ActionById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoleClaimHistories_ActionById",
                table: "AspNetUserRoleClaimHistories",
                column: "ActionById");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoleClaimHistories_UserRoleClaimId",
                table: "AspNetUserRoleClaimHistories",
                column: "UserRoleClaimId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoleClaims_RoleClaimId",
                table: "AspNetUserRoleClaims",
                column: "RoleClaimId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoleClaims_RoleId",
                table: "AspNetUserRoleClaims",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoleClaims_UserId",
                table: "AspNetUserRoleClaims",
                column: "UserId");
