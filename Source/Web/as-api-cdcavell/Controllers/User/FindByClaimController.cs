...
{
    /// <class>FindByClaimController</class>
    /// <summary>
    ...
    public class FindByClaimController : ApplicationBaseController<FindByClaimController>
    {
        /// <summary>
        /// Constructor method
        /// </summary>
        /// <param name="logger">ILogger&lt;FindByClaimController&gt;</param>
        ...
        /// <method>
        /// public FindByClaimController(
        ///     ILogger&lt;FindByClaimController&gt; logger,
        ...
        public IActionResult Post(object encryptObject)
        {
            try
            {
                ...
                Claim input = JsonConvert.DeserializeObject<Claim>(jsonString);
                
                List<ApplicationUser> users = _dbContext.Users
                    .Join(_dbContext.UserClaims, Users => Users.Id, UserClaims => UserClaims.UserId, (Users, UserClaims) => new { Users, UserClaims })
                    .Where(x => x.UserClaims.ClaimType == input.Type)
                    .Where(x => x.UserClaims.ClaimValue == input.Value)
                    .Select(x => x.Users)
                    .Include("Claims")
                    .Include("Logins")
                    .Include("Tokens")
