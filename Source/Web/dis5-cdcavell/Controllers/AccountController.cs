    ...
    public class AccountController : ApplicationBaseController<AccountController>
    {
        ...
        private async Task<LoggedOutViewModel> BuildLoggedOutViewModelAsync(string logoutId)
        {
            ...
            var vm = new LoggedOutViewModel
            {
                ...
                PostLogoutRedirectUri = string.IsNullOrEmpty(logout?.PostLogoutRedirectUri) ? _appSettings.Application.MainSiteUrlTrim + "/Home/Index" : logout?.PostLogoutRedirectUri,
